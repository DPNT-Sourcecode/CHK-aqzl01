...
class CheckoutSolution {
    ...
    #getBuyNGetMCrossDeals(counts) {
        // remove the conditional part of the BuyNGetM deal
        return this.#buyNGetMCrossSkus.entries().map(([boughtSku, deal]) => {
    ...
    checkout(skus) {
        ...
        const pricing = new Map([
            ...
            ...this.#getBuyNGetMCrossDeals(counts),
