...
class CheckoutSolution {
  ...
  checkout(skus) {
    ...
    const pricing = new Map([
      [
        "A",
        this.#pricingFactory("A", 5, 200, this.#pricingFactory("A", 3, 130)),
      ],
    ...
    for (const [sku, number] of Object.entries(counts)) {
      checkoutValue += pricing.get(sku)(number);
    }
